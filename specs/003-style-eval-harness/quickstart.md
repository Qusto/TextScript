# Quickstart Guide: StyleGuard Eval Harness
...
StyleGuard is an automated evaluation system for testing article generation quality. This guide will get you from zero to running your first evaluation in ~15 minutes.
...
- **Configuration**: See [data-model.md](./data-model.md) for full config schemas
- **Contracts**: See [contracts/](./contracts/) for detailed CLI and prompt specifications
